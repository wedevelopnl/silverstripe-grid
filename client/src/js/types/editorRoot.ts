import type { NodeRef } from './identity'
 ...
 */
export function rootParentRef(root: EditorRoot): NodeRef {
  return root.kind === 'page'
    ? { type: 'page', id: root.pageId }
    : { type: 'sharedBlock', id: root.blockId }
}
