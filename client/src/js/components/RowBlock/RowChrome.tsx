 ...
 * header — leading slot, collapse toggle, title, status pill, column-count
 * meta, trailing slot. The pill states this row's own status; that something
 * below it is unpublished is carried by the ring plus a screen-reader-only
 * note, not by a second visible mark. The columns body differs structurally
 * between modes, so it is an opaque `children` slot. Never branches on mode,
 * only on data.
 */
