...
| `base_restore_class` | `string` | Restore class for the base viewport (e.g. Bootstrap's `d-block`, not `d-xs-block`) |
| `responsive_restore_format` | `string` | Restore class for other viewports |
