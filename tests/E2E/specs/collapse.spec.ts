...
test.describe('Collapsible containers', () => {
  ...
  test('editor collapses containers to focus on content, state survives navigation and reload', async ({
    page,
  }) => {
    ...
    await test.step('collapsed state survives CMS navigation', async () => {
      ...
      await expect(sectionANav.getByTestId('collapse-toggle').first()).toHaveAttribute(
        'aria-expanded',
        'true',
      )
      await expect(sectionBNav.getByTestId('collapse-toggle').first()).toHaveAttribute(
        'aria-expanded',
        'true',
      )
      ...
      await expect(rowA1Nav.getByTestId('collapse-toggle').first()).toHaveAttribute(
        'aria-expanded',
        'true',
      )
      await expect(rowA2Nav.getByTestId('collapse-toggle').first()).toHaveAttribute(
        'aria-expanded',
        'false',
      )
      ...
      await expect(colA1LNav.getByTestId('collapse-toggle')).toHaveAttribute(
        'aria-expanded',
        'false',
      )
    ...
    await test.step('collapsed state survives a hard reload', async () => {
      ...
      await expect(sectionBReload.getByTestId('collapse-toggle').first()).toHaveAttribute(
        'aria-expanded',
        'true',
      )
      ...
      const colA1LReload = rowA1Reload
        .getByTestId('column-block')
        .filter({ hasText: 'Block A1-Left' })
      const colA1RReload = rowA1Reload
        .getByTestId('column-block')
        .filter({ hasText: 'Block A1-Right' })

      await expect(rowA1Reload.getByTestId('collapse-toggle').first()).toHaveAttribute(
        'aria-expanded',
        'true',
      )
      await expect(rowA2Reload.getByTestId('collapse-toggle').first()).toHaveAttribute(
        'aria-expanded',
        'false',
      )
      await expect(colA1LReload.getByTestId('collapse-toggle')).toHaveAttribute(
        'aria-expanded',
        'false',
      )
