...
/**
 * Shared run helpers for the WS4 migration characterization gate.
 *
 ...
 *
 * The DDL lifecycle and legacy constants live on {@see MigrationTestCase}; this
 * base adds the non-Fluent service driver so each scenario subclass shows only
 * the behaviour it characterizes.
 */
abstract class CharacterizationTestCase extends MigrationTestCase
{
    ...
    {
        return $this->logger->messagesAt($level);
    }
}
